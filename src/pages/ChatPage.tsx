          ...
          >
            <div
              className={`text-sm leading-relaxed ${
                !isUser ? "font-roboto" : "font-roboto"
              } ${!isUser ? "text-lg" : ""}`}
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-background dark:bg-background-dark">
        <div className="text-center">
          <div className="animate-spin h-8 w-8 border-2 border-background2-dark dark:border-background border-t-transparent rounded-full mx-auto mb-4"></div>
      ...
      <div className="flex-1 flex flex-col h-screen min-w-0 bg-background dark:bg-background-dark">
        ...
        {!currentSession ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center gap-3 px-4">
            ...
            <button onClick={createNewSession} className="button-styled w-60">
              Start New Chat
            </button>
          </div>
        ) : (
          <>
            {/* Header */}
            <div className="bg-background dark:bg-background2-dark border-b border-secondary dark:border-background px-4 py-3 flex-shrink-0">
            ...
            {/* Archived banner */}
            {currentSession.state === "archived" && (
              <div className="bg-third dark:bg-background2-dark border-b border-secondary dark:border-background px-4 py-2 flex-shrink-0">
                  ...
                  <div className="flex justify-start mb-4">
                    <div className="rounded-2xl px-4 py-2 mr-4 input-chat-container">
                      <div className="flex items-center space-x-2">
                        <div className="animate-spin h-4 w-4 border-2 border-background2-dark dark:border-background border-t-transparent rounded-full"></div>
            ...
            {/* Error */}
            {error && (
              <div className="mx-4 my-3 border border-red-600/30 rounded-lg bg-red-50 dark:bg-red-900/20 px-4 py-3 flex-shrink-0">
                <div className="flex items-center justify-between">
